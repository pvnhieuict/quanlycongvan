...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 shadow rounded">
      ...
      <form method="POST" class="col-md-12" action="{{ route('cong-van-den.update', $dataTypeDocuments->id ) }}"
        enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        <div class="row align-items-center mb-2">
          <div class="col-2"><label for="number_label" class="col-form-label"> Số công văn:</label></div>
          <div class="col-6"><input type="text" class="form-control " name="label_number"
              value="{{ $dataTypeDocuments->label_number }}" /></div>
          <div class="col-4">
        ...
        <div class="row align-items-center mb-2">
          ...
          <div class="col-6"><input type="text" class="form-control " name="title"
              value="{{ $dataTypeDocuments->title }}" /></div>
          <div class="col-4">
        ...
        <div class="row align-items-center mb-2">
          ...
          <div class="col-6">
            <select name="type_id" class="form-control form-select">
              ...
              <option value="{{ $item->id }}" @if(old('type_id')==$dataTypeDocuments->type->id || $item->id ==
                $dataTypeDocuments->type->id) selected @endif>{{ $item->name }}</option>
              @endforeach
            </select>
          </div>
          <div class="col-4">
        ...
        <div class="row g-3 align-items-center mb-2">
          ...
          <div class="col-6">
            <a class="badge bg-success mb-2" href="{{Storage::url($dataTypeDocuments->pathpdf)}}" target="_blank">Link
              file</a>
        ...
        <div class="row g-3 align-items-center mb-2">
          ...
          <div class="col-6">
            <input type="date" name="signature_date" id="iddate" value="{{$dataTypeDocuments->signature_date}}"
        ...
        <div class="row g-3 align-items-center mb-2">
          ...
          <div class="col-6">
            <input type="date" name="in_date" id="iddate" value="{{$dataTypeDocuments->in_date}}"
              placeholder="dd-mm-yyyy" class="form-control">
          </div>
          <div class="col-4">
            <span id="" class="form-text">
        ...
        <div class="row g-3 align-items-center mb-2">
          ...
          <div class="col-6">
            <input type="date" name="store_date" id="iddate" value="{{$dataTypeDocuments->store_date}}"
              placeholder="dd-mm-yyyy" class="form-control">
          </div>
          <div class="col-4">
            <span id="" class="form-text">
        ...
        <div class="row g-3 align-items-center mb-2">
          ...
          <div class="col-6">
            <textarea type="textarea" cols="10" rows="3" name="detail" id="iddate" class="form-control"
              value="{{$dataTypeDocuments->detail}}"></textarea>
          </div>
          <div class="col-4">
            <span id="" class="form-text">
        ...
        <div class="row g-3 align-items-center mb-2">
          ...
          <div class="col-6">
            <input type="number" name="copy_number" id="" value="{{$dataTypeDocuments->copy_number}}"
              class="form-control">
          </div>
          <div class="col-4">
            <span id="" class="form-text">
