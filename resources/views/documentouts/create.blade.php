...
@extends('layouts.app')
@section('title','Nhập công văn đi')
  ...
  <div class="row">
    ...
    <main class="col-md-9 shadow rounded">
      <div
        ...
        <h1 class="h2">Nhập công văn đi</h1>
      ...
      <form method="post" class="col-md-12" action="{{ route('cong-van-di.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row g-3 align-items-center mb-2">
          ...
          <div class="col-6">
            <input type="date" name="out_date" id="iddate" placeholder="dd-mm-yyyy" class="form-control">
          </div>
          <div class="col-4">
            <span id="" class="form-text">
        ...
        <div class="row g-3 align-items-center mb-2">
          <div class="col-2">
            <label for="" class="col-form-label">Nơi đến</label>
          </div>
          <div class="col-6">
            <input type="text" name="to_place" id="" class="form-control">
          </div>
          <div class="col-4">
            <span id="" class="form-text">
