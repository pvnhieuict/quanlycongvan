    ...
    <div class="row">
        ...
        <main class="col-md-9 shadow rounded">
            <div class="d-flex justify-content-between flex-wrap  align-items-center border-bottom">
                <h1 class="h2 mt-1">CÔNG VĂN ĐẾN ĐƯỢC GIAO</h1>
            </div>
            ...
            <div class="uper">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @cannot('nguoidungthuong')
                            <td><a href="{{ route('cong-van-den.edit', $documentin->id)}}"
                ...
                <div
                    ...
                    <h1 class="h2">CÔNG VĂN ĐI ĐƯỢC GIAO</h1>
                ...
                <div class="uper">
                    ...
                    <table class="table table-striped shadow">
                        ...
                        <tbody>
                            @foreach($documentouts as $documenout)
                            <tr>
                                <td><a
                                ...
                                @cannot('nguoidungthuong')
                                <td><a href="{{ route('cong-van-di.edit', $documenout->id)}}"
                                        class="btn btn-primary">Edit</a></td>
                                <td>
